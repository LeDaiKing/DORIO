...
: State(stack, context)
, nBackgroundSprite()
, upButton(context, GUI::Button::Type::UpButton)
, leftButton(context, GUI::Button::Type::LeftButton)
, rightButton(context, GUI::Button::Type::RightButton)
, downButton(context, GUI::Button::Type::DownButton)
, attackButton(context, GUI::Button::Type::AttackButton)
, doubleUpButton(context, GUI::Button::Type::DoubleUpButton)
